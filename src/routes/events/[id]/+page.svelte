...
<section class="flex h-screen flex-col items-center justify-center">
	...
	<div class="lg:px-42 px-16 py-4 md:px-32 lg:pb-20">
		<h2 class="text-center font-inter text-3xl text-gray-900 dark:text-gray-100 lg:text-5xl lg:leading-normal">
			{title}
		</h2>
	</div>
	<div class="divide flex flex-row flex-nowrap justify-center p-4">
		{#if difference.negative}
			<span class="w-10 px-2 font-rubik text-5xl font-black text-gray-900 dark:text-gray-100 lg:w-44 lg:text-8xl"
				>-</span
			>
		{/if}
		<DateSegment number={difference.days} dateType={'Days'} />
		<span class="my-2 font-bold lg:text-6xl dark:text-gray-100">:</span>
